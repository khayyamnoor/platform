...
import { Film, Image as ImageIcon, Music, Sun, Video, Zap, Play, Camera, Clock, Loader2, Sparkles, Wand2 } from 'lucide-react';
...
export default function App() {
  ...
  useEffect(() => {
    // If the API key is injected correctly from the environment, we use it.
    // In AI Studio, process.env.GEMINI_API_KEY is mapped to VITE_GEMINI_API_KEY or replaced in vite.config.
            ...
            properties: {
              ...
              videos: {
                ...
                items: {
                  ...
                  required: ["sequence", "duration", "startImageRef", "endImageRef", "cameraMovement", "sceneDescription", "technicalPrompt"]
                }
              }
            },
    ...
    <div className="min-h-[100vh] bg-[#050505] text-[#f5f5f5] font-sans selection:bg-[#D4AF37]/30 selection:text-[#F1D592] border-8 border-[#0a0a0a]">
      ...
      <header className="max-w-7xl mx-auto px-10 pt-10 flex justify-between items-baseline mb-12 border-b border-gold pb-6">
        <div className="flex flex-col">
          <span className="text-[10px] tracking-[0.4em] uppercase opacity-60 mb-2">Cinematic Production Portfolio</span>
        ...
        <div className="text-right hidden md:block">
          <p className="text-xs uppercase tracking-widest opacity-50 mb-1">Project ID: GS-2024-082</p>
          ...
          <aside className="w-full lg:w-1/3 flex flex-col gap-8">
            <div className="flex flex-col">
              ...
              <p className="text-sm opacity-80 font-light mb-4 leading-relaxed">
                Paste your instructions, slash commands (e.g., /analyze, /canvas-design), or raw thoughts here. The AI will structure it into a production-ready storyboard.
              </p>
            ...
            <AnimatePresence mode="wait">
              {!result && !isGenerating ? (
                ...
                >
                  ...
                  <h3 className="font-serif text-[#f5f5f5] italic text-2xl mb-2">Awaiting Directives</h3>
                ...
                >
                  <div className="absolute inset-0 opacity-20" style={{ background: "radial-gradient(circle at center, #D4AF37, transparent)" }}></div>
                  <Loader2 className="w-10 h-10 text-[#D4AF37] animate-spin mb-6 relative z-10" />
                  <h3 className="text-2xl font-serif italic text-white mb-2 relative z-10">Processing Sequence...</h3>
                ...
                >
                  ...
                  <div className="bg-glass border border-gold p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h2 className="text-[11px] uppercase tracking-[0.2em] mb-3 text-[#D4AF37] font-semibold">Analysis Summary</h2>
                    ...
                    {result.videos.map((video, idx) => (
                      ...
                      >
                        ...
                        <div className="flex justify-between items-center p-4 border-b border-gold/10">
                          <span className="text-[10px] uppercase tracking-widest text-[#D4AF37]">Sequence {String(video.sequence).padStart(2, '0')}</span>
                        ...
                        <div className="absolute inset-0 opacity-5 pointer-events-none" style={{ background: "radial-gradient(circle at top right, #D4AF37, transparent)" }}></div>
                      </motion.div>
                    ))}
                  </div>
                </motion.div>
